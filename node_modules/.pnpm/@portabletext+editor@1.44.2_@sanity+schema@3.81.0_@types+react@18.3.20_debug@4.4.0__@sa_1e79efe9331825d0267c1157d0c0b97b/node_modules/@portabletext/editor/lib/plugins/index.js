...
import { coreBehaviors, defineBehavior, raise } from "../_chunks-es/behavior.core.js";
...
function CoreBehaviorsPlugin() {
  const $ = c(1);
  let t0;
  return $[0] === Symbol.for("react.memo_cache_sentinel") ? (t0 = /* @__PURE__ */ jsx(BehaviorPlugin, { behaviors: coreBehaviors }), $[0] = t0) : t0 = $[0], t0;
}
...
const oneLineBehaviors = [
  ...
  defineBehavior({
    ...
    guard: ({
      snapshot,
      event
    }) => event.blocks.filter((block) => isTextBlock(snapshot.context, block)).reduce((targetBlock, incomingBlock) => mergeTextBlocks({
