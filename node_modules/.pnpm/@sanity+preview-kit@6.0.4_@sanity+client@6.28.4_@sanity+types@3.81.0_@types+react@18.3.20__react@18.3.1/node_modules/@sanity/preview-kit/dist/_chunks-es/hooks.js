import require$$0, { createContext, useState, useEffect, useSyncExternalStore, useContext, useMemo, useCallback } from "react";
...
var reactFastCompareExports = requireReactFastCompare(), isEqual = /* @__PURE__ */ getDefaultExportFromCjs(reactFastCompareExports), withSelector = { exports: {} }, useSyncExternalStoreWithSelector_production = {};
/**
 * @license React
...
function requireUseSyncExternalStoreWithSelector_production() {
  ...
  var objectIs = typeof Object.is == "function" ? Object.is : is, useSyncExternalStore2 = React.useSyncExternalStore, useRef = React.useRef, useEffect2 = React.useEffect, useMemo2 = React.useMemo, useDebugValue = React.useDebugValue;
  return useSyncExternalStoreWithSelector_production.useSyncExternalStoreWithSelector = function(subscribe, getSnapshot, getServerSnapshot, selector, isEqual2) {
    ...
    instRef = useMemo2(
      function() {
        function memoizedSelector(nextSnapshot) {
          if (!hasMemo) {
            if (hasMemo = !0, memoizedSnapshot = nextSnapshot, nextSnapshot = selector(nextSnapshot), isEqual2 !== void 0 && inst.hasValue) {
...
function requireUseSyncExternalStoreWithSelector_development() {
  return hasRequiredUseSyncExternalStoreWithSelector_development || (hasRequiredUseSyncExternalStoreWithSelector_development = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    var React = require$$0, objectIs = typeof Object.is == "function" ? Object.is : is, useSyncExternalStore2 = React.useSyncExternalStore, useRef = React.useRef, useEffect2 = React.useEffect, useMemo2 = React.useMemo, useDebugValue = React.useDebugValue;
    useSyncExternalStoreWithSelector_development.useSyncExternalStoreWithSelector = function(subscribe, getSnapshot, getServerSnapshot, selector, isEqual2) {
      var instRef = useRef(null);
      if (instRef.current === null) {
        var inst = { hasValue: !1, value: null };
        instRef.current = inst;
