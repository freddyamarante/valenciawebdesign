...
function useLiveQuery(initialData, query, queryParams, options) {
  const { isEqual: isEqual$1 = isEqual } = options || {}, defineStore = require$$0.useContext(defineStoreContext), params = useQueryParams(queryParams), noStore = require$$0.useMemo(
    () => ({
      subscribe: () => () => {
      },
...
exports.useShouldPause = useShouldPause;
